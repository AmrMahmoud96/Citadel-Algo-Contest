...
def spread_bot(session):
    ...
    if bookWM.bid_price()+0.01 < bookWM.ask_price()-0.01:
        session.send_order('WMT-M', 'SELL', bookWM.ask_price()-0.01,  12000)
        session.send_order('WMT-M', 'BUY', bookWM.bid_price()+0.01, 12000)
    # #tight up
    ...
    if bookWA.bid_price()+0.01 < bookWA.ask_price()-0.01:
        session.send_order('WMT-A', 'SELL', bookWA.ask_price()-0.01,  12000)
        session.send_order('WMT-A', 'BUY', bookWA.bid_price()+0.01, 12000)
    # #tight up
    ...
    #     session.send_order('CAT-M', 'SELL', bookCM.ask_price(),  5000)
    #     session.send_order('CAT-M', 'BUY', bookCM.bid_price()+0.01, 5000)
    # #tight down
    # if bookCM.bid_price() < bookCM.ask_price()-0.01:
    #     session.send_order('CAT-M', 'SELL', bookCM.ask_price()-0.01,  5000)
    #     session.send_order('CAT-M', 'BUY', bookCM.bid_price(), 5000)
    ...
    #     session.send_order('CAT-A', 'SELL', bookCA.ask_price(),  5000)
    #     session.send_order('CAT-A', 'BUY', bookCA.bid_price()+0.01, 5000)
    # #tight down
    # if bookCA.bid_price() < bookCA.ask_price()-0.01:
    #     session.send_order('CAT-A', 'SELL', bookCA.ask_price()-0.01,  5000)
    #     session.send_order('CAT-A', 'BUY', bookCA.bid_price(), 5000)

    #not tight
    if bookMM.bid_price()+0.01 < bookMM.ask_price()-0.01:
        session.send_order('MMM-M', 'SELL', bookMM.ask_price()-0.01,  7500)
        session.send_order('MMM-M', 'BUY', bookMM.bid_price()+0.01, 7500)
    # #tight up
    ...
    if bookMA.bid_price()+0.01 < bookMA.ask_price()-0.01:
        session.send_order('MMM-A', 'SELL', bookMA.ask_price()-0.01,  7500)
        session.send_order('MMM-A', 'BUY', bookMA.bid_price()+0.01, 7500)
    #tight up
    ...
    if bookETF.bid_price()+0.01 < bookETF.ask_price()-0.01:
        session.send_order('ETF', 'SELL', bookETF.ask_price()-0.01,  2500)
        session.send_order('ETF', 'BUY', bookETF.bid_price()+0.01, 2500)
    # #tight up
    # if bookETF.bid_price()+0.01 < bookETF.ask_price():
    #     session.send_order('ETF', 'SELL', bookETF.ask_price(),  5000)
    #     session.send_order('ETF', 'BUY', bookETF.bid_price()+0.01, 5000)
    # #tight down
    # if bookETF.bid_price() < bookETF.ask_price()-0.01:
    #     session.send_order('ETF', 'SELL', bookETF.ask_price()-0.01,  5000)
    #     session.send_order('ETF', 'BUY', bookETF.bid_price(), 5000)
...
def news_adjusted_price(jsonresp,session):
    global adjusted_price,bookWM,bookWA,bookMM,bookMA,bookCM,bookCA,bookETF
...
##potentially put trade here to account for news
    ...
    if val!=0:
        ...
        session.send_order(jsonresp['ticker']+'-A', 'BUY', bookA.ask_price()+0.01 + val,  (abs(val))/(0.01*bookM.bid_price())*100000)
